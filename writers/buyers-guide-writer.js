...
function getBuyingFactors(niche) {
  ...
  if (nicheLower.includes('earbud') || nicheLower.includes('headphone')) {
    return [
      ...
      { name: 'Noise Isolation and Comfort', description: 'Essential for travel and noisy environments. Look for good passive noise isolation through well-fitting ear cups or tips, and transparency/ambient modes for situational awareness.' },
