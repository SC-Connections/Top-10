 ...
 * Note: This function is ONLY used for estimating reading time of programmatically
 * generated blog content. It is NOT used for sanitizing user input or preventing XSS.
 * The content passed to this function is entirely generated by our own code,
 * never from external or user sources.
 * 
 * @param {string} content - HTML content (programmatically generated, not user input)
 * @returns {number} Estimated minutes to read
 */
function estimateReadingTime(content) {
    const wordsPerMinute = 200;
    
    // Simple approach: strip HTML tags and count words
    // This is safe because content is always programmatically generated by this module
    // and never contains user input or external data
